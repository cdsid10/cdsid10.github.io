...
export default function Sidebar() {
  ...
  const getNavItemClasses = (isActive: boolean, projectId?: string) => {
    ...
    return cn(
      "block py-1 text-sm font-display tracking-[1px] transition-all duration-75",
      shouldHighlight ? "text-ink opacity-100" : "text-ink/50 hover:text-ink transition-colors duration-75"
    );
  };
  ...
  return (
    <>
      ...
      */}
      <header className={cn(
        "lg:hidden fixed top-0 left-0 right-0 h-16 bg-paper z-[60] flex items-center justify-between px-8 border-b border-ink/5 transition-all duration-75",
        ...
        <div className="flex items-center gap-7 h-full">
          ...
          <button
            ...
            className="text-ink transition-transform duration-150"
      ...
      */}
      <aside
        ...
        className={cn(
          ...
          "lg:translate-x-0 transition-colors duration-75 lg:shadow-[4px_0_24px_rgba(0,0,0,0.05)]",
