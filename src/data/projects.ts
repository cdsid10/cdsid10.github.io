...
`
  },
  {
    ...
    thumbnail_16_9: '/images/SelfApart/0.webp',
    thumbnail_mobile: '/images/SelfApart/0.webp',
    accentColor: '#4C7F33',
    year: '2022',
    ...
    gallery: [
      '/images/SelfApart/1.webp',
      '/images/SelfApart/2.webp',
      '/images/SelfApart/3.webp',
      '/images/SelfApart/4.webp',
      '/images/SelfApart/5.webp'
    ],
...
Designed and refined the limb-based interaction system, focusing on responsive interactions and organic puzzle integrations. Also, designed a minimal UI that stayed out of the way, while still guiding players through their available choices.
  ...
  //   category: 'featured-works',
  //   isExternalOnly: true,
  //   thumbnail_16_9: '/images/Diving_Deeper/1.webp',
  //   thumbnail_mobile: '/images/Diving_Deeper/1.webp',
  //   accentColor: '#3B2202',
  //   year: '2024',
  ...
  // },
  {
    ...
    thumbnail_16_9: '/images/Football_Academy/1.webp',
    thumbnail_mobile: '/images/Football_Academy/1.webp',
...
export const mobileProjects: Project[] = [
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Musical_DIY/1.webp',
    thumbnail_mobile: '/images/Musical_DIY/1.webp',
    accentColor: '#4C8F88',
    year: '2023',
    roles: ['Junior Developer - Rawky Games'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Largest_Laser/1.webp',
    thumbnail_mobile: '/images/Largest_Laser/1.webp',
    accentColor: '#5A3D5C',
    year: '2023',
    roles: ['Junior Developer - Rawky Games'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Spiral_Clicker/1.webp',
    thumbnail_mobile: '/images/Spiral_Clicker/1.webp',
    accentColor: '#7A84D9',
    year: '2023',
    roles: ['Junior Developer - Rawky Games'],
    tech: ['Unity', 'C#'],
...
export const otherProjects: Project[] = [
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Diving_Deeper/1.webp',
    accentColor: '',
    year: '2024',
    roles: ['Game Designer', 'Developer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Bhief/1.webp',
    accentColor: '',
    year: '2022',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/NWO/1.webp',
    accentColor: '',
    year: '2022',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/For_The_Ring/1.webp',
    accentColor: '',
    year: '2022',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Dimensio/1.webp',
    accentColor: '',
    year: '2022',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Cryo/1.webp',
    accentColor: '',
    year: '2021',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Saber/1.webp',
    accentColor: '',
    year: '2021',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Kibi/1.webp',
    accentColor: '',
    year: '2021',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Nothing/1.webp',
    accentColor: '',
    year: '2020',
    roles: ['Game Designer'],
    tech: ['Unity', 'C#'],
  ...
  },
  {
    ...
    category: 'other-works',
    isExternalOnly: true,
    thumbnail_16_9: '/images/Archive/Direlude/1.webp',
    accentColor: '',
    year: '2020',
